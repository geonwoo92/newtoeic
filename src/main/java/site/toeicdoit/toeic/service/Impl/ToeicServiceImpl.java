...
public class ToeicServiceImpl implements ToeicService {
    ...
    @Override
    public List<ToeicModel> findAllByExam(Long CategoryId) {
        return toeicRepository.findAllByExam(CategoryId);
    }


    @Override
    public List<ToeicModel> findAllByTest() {
        return toeicRepository.findAllByTest();
    }

    @Override
    public List<ToeicModel> findAllByLevel(Long level) {
        return toeicRepository.findAllByLevel(level);
    }

    @Override
    public List<ToeicModel> findAllByPart(String part) {
